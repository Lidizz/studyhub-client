  ...
  return (
    <div className={`flex min-h-screen ${bg}`}>
      <div
        ...
        style={{ backgroundImage: "url(/study2.jpg)" }}
      />
      <div className="w-full md:w-1/2 flex items-center justify-center p-4 md:p-6">
        ...
        >
          ...
          {error && (
            <p
              className={`text-center text-sm ${theme === "light" ? "text-red-600" : "text-red-400"}`}
            >
              {error}
            </p>
          )}
          <form onSubmit={handleSubmit} className="space-y-6 mt-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <label
                  htmlFor="remember-me"
                  className={`ml-2 block text-sm ${text}`}
                >
                  Remember me
                </label>
              </div>
              <a
                ...
                className={`text-sm ${theme === "light" ? "text-[#9333ea]" : "text-[#38bdf8]"} hover:underline`}
              >
                Forgot password?
              </a>
            </div>
          ...
          <p className={`text-center text-sm mt-4 ${text}`}>
            ...
            <Link
              to="/signup"
              className={`${theme === "light" ? "text-[#9333ea]" : "text-[#38bdf8]"} hover:underline`}
            >
              Register
            </Link>
          </p>
