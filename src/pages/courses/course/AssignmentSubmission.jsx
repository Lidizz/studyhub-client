...
const AssignmentSubmission = () => {
    ...
    if (loading) return <div className={`p-6 ${bg} ${text}`}>Loading assignment...</div>;
    if (error && userRole === 'STUDENT') return <div className={`p-6 text-red-600 ${bg}`}>Error: {error}</div>;
    if (!assignment && assignmentId && userRole === 'STUDENT') return <div className={`p-6 ${bg} ${text}`}>Assignment not found!</div>;
                    ...
                    <div className={`rounded-lg shadow-md ${border}`}>
                        ...
                        <div className="p-6">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={(e) =>
                                            setSubmissionForm((prev) => ({ ...prev, text: e.target.value }))
                                        }
                                ...
                                <div className={`mt-6 p-4 rounded-lg ${
                                    ...
                                    <div className={`text-sm ${
                                        ...
                                        <div className={`p-3 rounded ${
                                            theme === "light" ? "bg-white border border-green-200" : "bg-gray-800 border border-green-600"
                                        }`}>
                            ...
                            <div className={`border-t ${
                                ...
                                <h3 className={`text-lg font-semibold ${text} mb-4`}>Instructor Feedback</h3>

                                <div className="mb-4">
                                    <label className={`block text-sm font-medium ${text} mb-2`}>Grade</label>
                                    <div className={`px-4 py-2 ${
                                        theme === "light" ? "bg-gray-50 border-gray-200" : "bg-gray-800 border-gray-600"
                                    } border rounded-md`}>
                                        <span className={`${
                                            submissionData.grade
                                                ? (theme === "light" ? "text-green-600 font-semibold" : "text-green-400 font-semibold")
                                                : (theme === "light" ? "text-gray-500" : "text-gray-400")
                                        } ${submissionData.grade ? '' : 'italic'}`}>
                                ...
                                <div>
                                    <label className={`block text-sm font-medium ${text} mb-2`}>Feedback</label>
                                    <div className={`px-4 py-3 ${
                                        theme === "light" ? "bg-gray-50 border-gray-200" : "bg-gray-800 border-gray-600"
                                    } border rounded-md min-h-[80px]`}>
                                        <p className={`${
                                            submissionData.feedback
                                                ? text
                                                : (theme === "light" ? "text-gray-500" : "text-gray-400")
                                        } ${submissionData.feedback ? '' : 'italic'}`}>
                                ...
                                {assignments.length === 0 ? (
                                    ...
                                    <div className="space-y-4">
                                        {assignments.map((assignmentItem) => (
                                            <div key={assignmentItem.id} className={`border ${border} rounded-lg p-4`}>
                            ...
                            <div className="p-6">
                                <form onSubmit={editAssignment ? handleUpdateAssignment : handleCreateAssignment} className="space-y-6">
                                    ...
                                    <div className="flex items-center justify-end gap-4">
                                        ...
                                        <button
                                            type="submit"
                                            className={`px-6 py-2 ${accentBg} ${
                                                theme === "light" ? "text-light-bg" : "text-dark-bg"
                                            } rounded-lg hover:bg-[#7b2cbf] transition-colors font-medium flex items-center gap-2`}
                                        >
                                    ...
                                    {courseSubmissions.length === 0 ? (
                                        ...
                                        <div className="space-y-4">
                                            {courseSubmissions.map((submission) => (
                                                <div key={submission.id} className={`border ${border} rounded-lg p-4`}>
                                                    <div className="flex justify-between items-start">
                                                        <div className="flex-1">
                                                            <h3 className={`text-lg font-semibold ${text} mb-2`}>
                ...
                {showDeleteConfirm && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className={`${bg} rounded-lg p-6 max-w-md mx-4`}>
                            <h3 className={`text-lg font-semibold mb-4 ${text}`}>Delete Assignment</h3>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className={`${bg} rounded-lg p-6 max-w-md mx-4 w-full`}>
                            <h3 className={`text-lg font-semibold mb-4 ${text}`}>
                                Grade Submission - Student ID: {selectedSubmission?.studentId}
                            </h3>
