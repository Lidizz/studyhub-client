...
export const submitAssignment = async (
  ...
  formData.append("file", file);
  return api.post(
    `/courses/${courseId}/submissions/${assignmentId}/student/${studentId}`,
    formData,
    {
      headers: { "Content-Type": "multipart/form-data" },
    },
...
export const downloadSubmission = async (courseId, assignmentId, studentId) => {
  return api.get(
    `/courses/${courseId}/submissions/${assignmentId}/student/${studentId}/download`,
    {
      responseType: "blob", // For file downloads
    },
  );
...
export const getSubmissionsByAssignment = async (courseId, assignmentId) => {
  return api.get(
    `/courses/${courseId}/submissions/${assignmentId}/submissions`,
  );
};
...
export const gradeSubmission = async (
  ...
  return api.put(
    `/courses/${courseId}/submissions/${assignmentId}/student/${studentId}/grade`,
    gradeData,
  );
};
